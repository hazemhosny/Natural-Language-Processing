...
# added by user due to error in ChatterBotCorpusTrainer
...
class DialogueManager(object):
    ...
    def __init_chitchat_bot(self):
        ...
        dirname = "/usr/local/lib/python3.7/dist-packages/chatterbot_corpus/data/english"
    ...
    def generate_answer(self, question):
        ...
        if intent == 'dialogue':
            ...
            response = response = self.chitchat_bot.get_response(question) #### YOUR CODE HERE ####
            return response
        ...
        # Goal-oriented part:
            ...
            thread_id = thread_id = self.thread_ranker.get_best_thread(prepared_question, tag) #### YOUR CODE HERE ####
